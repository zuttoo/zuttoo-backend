...
export const FGStatusUpdateTemplate = (arg: RmOrderArg) => {
      ...
      <mj-section>
        <mj-column>
          <mj-text font-size="16px">
            Chassis finished good chassis material
            number 23774774 has been welded and assembled
            at
