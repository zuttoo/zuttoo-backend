...
export const RMOrderUpdateDoneTemplate = (arg: RmOrderArg) => {
    ...
    <mj-wrapper padding="50px 30px" background-color="#fafafa">
      ...
      <mj-section>
        <mj-column>
          <mj-text font-size="16px">
            Your raw material purchase order
            number 4557683 placed on 2oth April 2024 is
            currently in Processing
            at Amar Steelworks end. The processing stage
            has been delayed by 2 day(s).
          </mj-text>
        </mj-column>
      ...
      <mj-section padding="20px" background-color="#E0E7FF" border-radius="8px">
        <mj-column>
          ...
          <mj-table>
            <tr>
              <td style="padding-bottom:5px;">P.O. No.:</td>
            ...
            <tr>
              <td style="padding-bottom:5px">Supplier:</td>
              <td style="padding-bottom:5px">CW20230401</td>
            </tr>
            <tr>
              <td>Order Status:</td>
              <td style=" background: #F59E0B; padding: 4px; border-radius:8px;">Delayed</td>
            </tr>
          </mj-table>
